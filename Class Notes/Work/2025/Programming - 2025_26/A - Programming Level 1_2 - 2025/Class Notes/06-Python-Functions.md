...
Waits until the user puts some information down, then
returns their input.
...
parentheses. If there are any values that we need,
we put them in the parentheses.
...
The **return** keyword is used to give the function an
**output value**.  In a function, the `return` keyword
will stop the execution of the rest of the function.
