...
"current_number is lower than 43! set the lowest_number to 1 and the lowest_index to 3"

New values:
lowest_number = 1
lowest_index  = 3

Third and Fourth Comparisons:
-----------------------------
  --   *   2  3   %%  %%
[-11, 43, 55, 1, 100, 34]
...
"100 and 34 and not lower than 1, we've reached the end!"
